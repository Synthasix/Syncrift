        ...
        <div className="relative z-10">
          ...
          <section className="h-screen flex flex-col items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-8xl -mt-10 mb-4 relative z-20 font-bold bg-gradient-to-r from-sky-400 via-purple-500 to-pink-400 inline-block text-transparent bg-clip-text">
                Syncrift
              </h1>
              <p
